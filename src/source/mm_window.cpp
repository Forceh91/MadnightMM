...
bool mm_create_window(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine)
{
	...
	mm_window = CreateWindowEx(WS_EX_CLIENTEDGE, _TEXT("MadnightMM"), _TEXT("DiRT Rally Mod Manager"), WS_CAPTION | WS_SYSMENU | WS_MINIMIZE, CW_USEDEFAULT, CW_USEDEFAULT, 800, 830, 0, 0, hInstance, 0);
	if (!mm_window)
		return false;
